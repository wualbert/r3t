...
class Base_DC_Reachable_Set(ReachableSet):
    ...
    '''
    def __init__(self, x_range=np.asarray([0,10]), y_range=np.asarray([-5,5]), x_resolution=0.5,
                 y_resolution=0.5, theta_resolution=0.3,turn_radius = 2, is_reachables= None, costs = None):
